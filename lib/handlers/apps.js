...
prototype.getNumberOfCurrentPlayers = function(appID, callback) {
  this._send(EMsg.ClientGetNumberOfCurrentPlayersDP, new schema.CMsgDPGetNumberOfCurrentPlayers({"appid": appID}), callback);
};
...
handlers[EMsg.ClientGetNumberOfCurrentPlayersDPResponse] = function(data, callback) {
  ...
  callback(proto.eresult, proto.player_count);
};