...
ProtoBuf.loadProtoFile(path.join(__dirname, '../resources/protobufs/steamclient/steammessages_gameservers.steamclient.proto'), builder);
...
require('./handlers/steammessages_unified');
require('./handlers/master_server');
require('./handlers/apps');
require('./handlers/master_server');
require('./handlers/steamapps');
